...
export default function AdminQuoteWorkspace(){
  ...
  async function saveProposal(e){e.preventDefault();setSaving(true);try{setQuote(await updateAdminQuote(quote.id,{...quote,status:'sent'},adminToken))}catch(e){setError(e.message)}finally{setSaving(false)}}
