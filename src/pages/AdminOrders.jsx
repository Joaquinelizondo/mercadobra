  ...
  return (
    <section className="admin-orders-page">
      <header className="admin-orders-header">
        ...
        <nav><Link to="/admin/productos">Productos</Link><Link to="/admin/cotizaciones">Consultas</Link><Link to="/admin/personalizaciones">Personalizaciones</Link><Link to="/">Ver tienda ↗</Link></nav>
      </header>
